...
namespace Turbo.Plugins.inferno.DirectionLine{
    ...
    public class DirectionLinesConfig : BasePlugin, ICustomizer
    {
        ...
        public void Customize()
        {
            ...
            Hud.RunOnPlugin<inferno.DirectionLine.DirectionLinesPlugin>(plugin =>
            {
                ...
                plugin.MonsterBrushes[ActorRarity.Rare].Anim = inferno.DirectionLine.Line.AnimType.WidthMod;
