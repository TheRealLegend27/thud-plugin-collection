...
namespace Turbo.Plugins.Inferno.Minimap
{
    public class ShrineLabelsPlugin : BasePlugin, ICustomizer, IInGameWorldPainter
    {
        ...
        public WorldDecoratorCollection CreateMapDecorators(float size = 8f, int a = 192, int r = 255, int g = 255, int b = 55, float radiusOffset = 5f)
        {
        ...
        public WorldDecoratorCollection CreateGroundLabelDecorators(float size = 12f, int a = 192, int r = 255, int g = 255, int b = 55,int bga = 255, int bgr = 0, int bgg = 0, int bgb = 0)
        {
        ...
        public void PaintWorld(WorldLayer layer)
        {
            ...
            foreach (var shrine in shrines)
            {
                ...
                if (shrine.Type == ShrineType.PoolOfReflection && ShowPoolOfReflection == true) continue;
