        ...
        public override void Load(IController hud)
        {
            ...
            QuestDecorator = new WorldDecoratorCollection(
                new MapShapeDecorator(Hud)
                {
                    ...
                    ShadowBrush = Hud.Render.CreateBrush(96, 122, 0, 0, 1),
                    Radius = 10.0f,
                    ShapePainter = new CircleShapePainter(Hud),
                },
                new MapLabelDecorator(Hud)
                {
                    LabelFont = Hud.Render.CreateFont("tahoma", 6f, 120, 255, 255, 0, false, false, 128, 0, 0, 0, true),
                    RadiusOffset = 10,
                    Up = true,
                },
                new MapShapeDecorator(Hud)
                {
                    Brush = Hud.Render.CreateBrush(255, 100, 255, 55, -1),
