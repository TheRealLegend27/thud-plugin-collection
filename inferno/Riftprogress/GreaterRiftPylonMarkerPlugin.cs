...
namespace Turbo.Plugins.inferno
{
    ...
    public class GLQ_GreaterRiftPylonMarkerExtendedPlugin : BasePlugin, IInGameTopPainter
    {
        ...
        public override void Load(IController hud)
        {
            ...
            Pylon_Buff.Add(262935,"POWR"); Pylon_Buff.Add(266258,"CHAN"); Pylon_Buff.Add(266254,"SHLD");
            Pylon_Buff.Add(266271,"SPED"); Pylon_Buff.Add(403404,"COND"); 
        }
                ...
                if (ui.Visible)  {
                    ...
                    foreach (var actor in shrines)  { 
                        switch ((uint)actor.SnoActor.Sno)   {                           
                            case 330695: poder = "POWR";  break;
                            case 330696:
                            case 398654: poder = "COND";  break;
                            case 330697: poder = "CHAN";  break;
                            case 330698: poder = "SHLD";  break;
                            case 330699: poder = "SPED";  break;
...
// Para parchear que Hud.Game.Me.SnoArea.NameLocalized no se actualice inmediatamente al entrar en un mapa. Hay problemas si el pilón está cerca de la puerta
                   ...
                   foreach (string s in keyColl)  { 
                        if  (ProgressionofShrines.TryGetValue(s, out valuesOut)) {
                             ...
                             string piso = valuesOut.Item2.Replace("Rift Level","Lvl");; //piso en el que salio el pilon
