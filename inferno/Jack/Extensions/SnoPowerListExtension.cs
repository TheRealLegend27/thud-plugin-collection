...
namespace Turbo.Plugins.inferno.Jack.Extensions
{
    public static class SnoPowerListExtension
    {
        ...
        public static IEnumerable<ISnoPower> GenericPowers(this ISnoPowerList powerList)
        {
            ...
            yield return powerList.BottomlessPotionOfRejuvenation; // 433021
            ...
            yield return powerList.BottomlessPotionOfKulleAid; // 344094
            yield return powerList.BottomlessPotionOfRejuvenation; // 405166
            yield return powerList.BottomlessPotionOfFear; // 428812
            yield return powerList.BottomlessPotionOfAmplification; // 434626
            yield return powerList.BottomlessPotionOfChaos; // 451310
